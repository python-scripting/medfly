...
<vs-row vs-w="12">
  ...
  <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-lg="3" vs-sm="4" vs-xs="12">
   <vs-button @click="popupActive2=true" color="dark" type="filled">New Department</vs-button>
  </vs-col>
...
<!--eof-->
    ...
    <template>
      <div class="flex">
        ...
        <vs-popup classContent="popup-example" title="Add New Department" :active.sync="popupActive2">
        <form>
          <div class="flex mb-4">
            <div class="w-1/4 h-12">Name</div>
            <div class="w-3/4 h-12"><vs-input class="w-full mb-3" placeholder="Ex: Endoscopy, Laparoscopy etc.." v-model="value1"/></div>
          </div>
          ...
          <div class="row">
            <div class="flex">
              ...
              <div class="w-1/3">
               <div class="w-full"><vs-button color="dark" type="filled" id="button-with-loading" class="vs-con-loading__container mr-2" @click="saveloader">Save Department</vs-button>
                </div>
              </div>
              <div class="w-1/3">
              </div>
          ...
          <p class="mt-2"> <i class="las la-check-circle la-lg text-success"></i> created new department.</p>
        </form>
...
import departments from '@/views/ag-grid-table/departments.json'
export default {
  data() {
    return {
