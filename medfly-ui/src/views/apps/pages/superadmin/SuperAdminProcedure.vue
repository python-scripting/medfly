...
<vs-row vs-w="12">
  ...
  <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-lg="2" vs-sm="4" vs-xs="12">
    <vs-button @click="popupActive2=true" color="dark" type="filled">Add Procedure </vs-button>
  </vs-col>
        ...
        <form>
          <div class="flex mb-4">
            ...
            <div class="w-3/4 h-12">
              <v-select placeholder="Select Department..." :options="departmentoptions"></v-select>
            </div>
          </div>
          <div class="flex mb-4">
          ...
          <div class="row">
            <div class="flex">
              ...
              <div class="w-1/3">
               <div class="w-full"><vs-button color="dark" type="filled" id="button-with-loading" class="vs-con-loading__container mr-2" @click="saveloader">Save Procedure</vs-button>
                </div>
              </div>
              <div class="w-1/3">
              </div>
...
export default {
  ...
  data() {
    return {
      ...
      selected: [],
      departmentoptions:['Endoscopy', 'Bronchoscopy'],
      'tableList': [
        'vs-th: Component',
        'vs-tr: Component',
        'vs-td: Component',
