...
<vs-row vs-w="12">
  ...
  <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-lg="2" vs-sm="4" vs-xs="12">
    <vs-button @click="popupActive2=true" color="dark" type="filled">New Role</vs-button>
  </vs-col>
...
<!--eof-->
      ...
      <div class="flex">
        ...
        <form>
          <div class="flex mb-4">
            ...
            <div class="w-3/4 h-12"><vs-input class="w-full mb-3" placeholder="Ex: Doctor, Nurse etc.." v-model="value1"/></div>
          </div>
          ...
          <div class="row">
            <div class="flex">
              ...
              <div class="w-1/3">
               <div class="w-full"><vs-button color="dark" type="filled" id="button-with-loading" class="vs-con-loading__container mr-2" @click="saveloader">Save Role</vs-button>
                </div>
              </div>
              <div class="w-1/3">
              </div>
    ...
    <!-- Save & Reset Button -->
   <vs-table  v-model="selected" pagination max-items="5" search :data="roles">
