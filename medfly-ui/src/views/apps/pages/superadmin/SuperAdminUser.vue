...
<vs-row vs-w="12">
  ...
  <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-lg="2" vs-sm="4" vs-xs="12">
     <vs-button @click="popupActive2=true" color="dark" type="filled">New User</vs-button>
  </vs-col>
        ...
        <form>
          ...
          <div class="row">
            <div class="flex">
              ...
              <div class="w-1/3">
               <div class="w-full"><vs-button color="dark" type="filled" id="button-with-loading" class="vs-con-loading__container mr-2" @click="saveloader">Save User</vs-button>
                </div>
              </div>
              <div class="w-1/3">
              </div>
