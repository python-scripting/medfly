...
<vs-row vs-w="12" vs-xs="12">
  ...
  <vs-col  vs-lg="10" vs-sm="6" vs-xs="12">
   <v-select size="small" :options="statuss" class="w-full mb-3"></v-select>
  </vs-col>
</vs-row>
 
<vs-row vs-w="12" class="mt-2" vs-xs="12">	  
	<vs-button color="dark" id="button-with-loading" class="vs-con-loading__container mr-1" @click="saveloader">Save</vs-button>
	<vs-button color="dark"  class="mr-1">Report</vs-button>
	<vs-button color="dark"  class="mr-1">Preview</vs-button>
	<vs-button color="dark"  class="mr-1">Print</vs-button>
	<vs-button color="dark">New</vs-button>
</vs-row>
...
<vs-row vs-w="12">
 ...
 <vs-button type="transparent" size="small"><feather-icon icon="DiscIcon"/></vs-button>
  <vx-input class="bg-dark text-white pt-3">00: {{value1}} :00/ 1:00:00</vx-input>
</template>
  </vs-col>
                  ...
                  <div class="flex flex-col justify-between">
                    <div class="flex">
                     ...
                     <div class="w-1/2 mt-1 ml-1">
                       ...
                       <vs-button size="small" color="danger"  type="border" icon-pack="feather" icon="icon-trash"></vs-button>
                         </div>
                    </div>
                  </div>
                </div>
...
<vs-row vs-w="12">
 ...
 <!--  <vs-button type="transparent"  color="dark"><feather-icon icon="PauseIcon"/></vs-button>
  ...
  <vs-button type="transparent"  size="small"><feather-icon icon="CameraIcon"/></vs-button>
 <vs-button type="transparent" size="small"><feather-icon icon="DiscIcon"/></vs-button>
  <vx-input class="bg-dark text-white pt-3"> {{value1}} :00:00/ 1:00:00</vx-input>
</template>
  </vs-col>
  <vs-col vs-type="flex"  vs-lg="3" vs-sm="4" vs-xs="12">
  </vs-col>
...
<!-- clipboard popup-->
 ...
 <zoombox src="require('@/assets/images/profile/user-uploads/user-03.jpg')" thumb="require('@/assets/images/profile/user-uploads/user-03.jpg')">
  <span>A caption</span>
...
export default {
  components:{
    'v-select': vSelect,VuePerfectScrollbar,zoombox,
  },
  data () {
    return {
