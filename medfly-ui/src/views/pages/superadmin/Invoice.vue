          ...
          <vx-input-group class="mb-base mr-3">
            ...
            <template slot="append">
              <div class="append-text btn-addon">
                <vs-button size="small" type="border" @click="mailTo = ''" class="whitespace-no-wrap">Email Invoice</vs-button>
              </div>
            </template>
          </vx-input-group>
          <div class="flex items-center">
            <vs-button size="small" class="mb-base mr-3" type="border" icon-pack="feather" icon="icon icon-download">Download</vs-button>
            <vs-button size="small" class="mb-base mr-3" icon-pack="feather" icon="icon icon-file" @click="printInvoice">Print</vs-button>
          </div>
        </div>
