        ...
        <vs-td>
          <vs-row>
           <vs-button  type="border" @click="popupActive2=true"  color="rgb(67,70,77)" class="mr-2" size="small" icon-pack="feather" icon="icon-edit-2"></vs-button>
            ...
            <vs-button type="border" @click=""  color="primary" class="mr-2" size="small" icon-pack="feather" icon="icon-settings"></vs-button>
        ...
        <vx-input-group  prependClasses="border border-solid border-grey border-r-0">
          ...
          <div class="row">
            <div class="flex">
              ...
              <div class="w-1/3">
               <div class="w-full"><vs-button @click="" color="rgb(67,70,77)" type="filled">Save Hospital</vs-button>
                </div>
              </div>
              <div class="w-1/3">
              </div>
