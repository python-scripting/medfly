...
<vs-row vs-w="12">
  ...
  <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-lg="3" vs-sm="4" vs-xs="12">
    <vs-button @click="popupActive2=true" color="rgb(67,70,77)" type="filled">New Nurse</vs-button>
  </vs-col>
...
<!--eof-->
    ...
    <template>
      <div class="flex">
        ...
        <vs-popup classContent="popup-example" title="Add New Nurse" :active.sync="popupActive2">
        <form>
          <div class="flex mb-4">
          ...
          <div class="row">
            <div class="flex">
              ...
              <div class="w-1/3">
               <div class="w-full"><vs-button  color="rgb(67,70,77)" type="filled" id="button-with-loading" class="vs-con-loading__container mr-2" @click="saveloader">Save Nurse</vs-button>
                </div>
              </div>
              <div class="w-1/3">
              </div>
          ...
          <p class="mt-2"> <i class="las la-check-circle la-lg text-success"></i>  new nurse created.</p>

        </vs-popup>
      </div>
</template>
    <!-- Save & Reset Button -->
   <vs-table  v-model="selected" pagination max-items="5" search :data="nurses">
...
import nurses from '@/views/ag-grid-table/nurse.json'
export default {
  data() {
    return {
